...
router.get('/getAllFavStuffs', function (req, res) {
...
router.get('/getAllFavStuffsNames', function (req, res) {
...
router.post('/addNewFavStuff*', function (req, res) {
...
router.put('/UpdateFavStuff/:FavStuffId*', function (req, res) {
    if ((typeof req.body.fav_stuff_name == "undefined") || (typeof req.body.fav_stuff_list == "undefined")) {
        res.json({error: true, message: "You need to provide 'fav_stuff_name' and 'fav_stuff_list'", response: ""});
    }
...
router.delete('/DeleteFavStuff', function (req, res) {
